    ...
    <div class="bg-gray-300 rounded-sm">
        <div class="flex items-center px-4 py-3 border-b border-gray-400 last:border-b-0">
            ...
            <div class="flex items-center justify-center mr-2">
                <button @click="onCheck" :class="{'text-green-600': isCompleted, 'text-gray-400': !isCompleted}">
            ...
            <div class="w-full">
                <input @keyup.enter="onTitleChange" v-model="title" type="text" placeholder="Digite a sua tarefa" class="bg-gray-300 placeholder-gray-500 text-gray-700 font-light focus:outline-none block w-full appearance-none leading-normal mr-3" />
            </div>

            <div class="ml-auto flex items-center justify-center">
                <button @click="confirmExclusion" class="focus:outline-none">
